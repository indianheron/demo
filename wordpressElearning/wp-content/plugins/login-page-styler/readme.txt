...
== Description ==
<strong>Custom Login</strong> Login page styler give's your admin login , login , registration and password recovery page new customized look  in few minutes zero coding skill required.More Features then any other custom login plugin , Full control over login page styling  and very easy to use ..  
...
1. Google fonts 
1. Unlimited custom login form colors.
1. Unlimited custom login background colors. 
...
<strong>Custom Login CSS Support.<strong>
...
<strong>Custom Login Style and Design Options.<.strong> 
...
<strong> Custom Login reCaptcha.</strong> The security keys from Google which will protects the website from harming programs and robots. The feature to add a reCaptcha and is well known by many site owners.
...
<strong> Custom Login plugin is also compatible with any plugin that hooks in the login form, including
...
<strong>Custom login - login page styler installed and activated  but not working, what should i do?</strong>
...
<strong> What image size to use for login background image?</strong>
...
<strong> What image size to use for logo image for login page?</strong>
...
<strong> What if I need to style login page element if plugin doesn't offer?</strong>
...
<strong> I'm not a designer for custom login, can you  customize our login ?</strong>
...
<strong> Do I need coding skills to design my login page?</strong>
...
<strong> Can i change login form position ?</strong>

Yes, Custom login - login page styler  gives you ability to change login form position.


<strong>. Can i change login form opacity to transparent ?</strong>
...
<strong> Can i change login form label color with this plugin ?</strong>

Yes, You can change  login form label  color with custom login - login page styler.

<strong> Can i change login form label font style ?</strong> 
